...
import SearchComponent from "../../components/SearchComponent";
    ...
    export default function movies({ moviesData }) {
        ...
        "@graph": [
          {
            ...
            "name": "Movies Free™ – Movies Section.",
          ...
          {
            "@type": "WebSite",
            "@id": "https://moviefree.vercel.app/movies#website",
            "url": "https://moviefree.vercel.app/movies",
            "name": "Movies Free™ – Movies Section.",
            "publisher": {
              "@type": "Organization",
              "@id": "https://moviefree.vercel.app/#organization"
          ...
          {
            "@type": "WebPage",
            "@id": "https://moviefree.vercel.app/movies#webpage",
            "url": "https://moviefree.vercel.app/movies",
            "name": "Movies Free",
            ...
            "mainEntity": [
              {
                "@type": "Article",
                "@id": "https://moviefree.vercel.app/movies",
                "url": "https://moviefree.vercel.app/movies",
      ...
      return (
        <>
        <Head>
        <title> Movies Free™ – Movies Section.</title>
       ...
       <meta name="keywords" content="moviefree, movies, watch movie online, free movies, free movies online, free movie streaming, moviefree movies free streaming, download free" />
        ...
        <meta
          property="og:title"
          content=" Movies Free™ – Movies Section. "
        />
      ...
      <SocialSharing />
        ...
        <button onClick={goBackToMain} style={styles.pageButton}>
          ...
          <h1 style={styles.title}>Movies Free™ Movies Section.</h1>
      ...
      <Link href={`/movies/${generateSlug(moviesItem.title)}`}>
        <div style={styles.card} className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex flex-col sm:text-left text-center">
            <h2 style={styles.cardTitle} className="text-xl font-semibold mb-2">{moviesItem.title}</h2>
            <p style={styles.cardDate} className="text-gray-500 text-sm mb-2">Upload Date: {moviesItem.year}</p>
            <p style={styles.cardDescription} className="text-gray-600">{moviesItem.synopsis}</p>
          </div>
        </div>
      </Link>
    </li>
