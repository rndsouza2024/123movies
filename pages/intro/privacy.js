...
const Privacy = () => {
  ...
  return (
    <div>
       <Head>
        <title>MoviesFree™ | Privacy Policy</title>
        ...
        />
          ...
          <link rel='canonical' href='https://moviefree.vercel.app/intro/privacy' />
          ...
          <meta
            ...
            content='MoviesFree™ - Stream HD movies and TV series for free on MoviesFree Online. Online. Stream. Download. full-length movies and shows in HD quality without registration.'
          />
          <meta property='og:url' content='https://moviefree.vercel.app/intro/privacy/' />
          <meta
...
<section className="mb-32 text-gray-800">
  <div className="flex flex-wrap">
    <div className="grow-0 shrink-0 basis-auto mb-12 md:mb-0 w-full  px-3 lg:px-6">
      ...
      <p className="font-bold mb-2">MoviesFree™ </p>
      <p className="text-gray-500 mb-6">
      MoviesFree™ International(MoviesFree™) is committed to protecting your privacy. This Privacy Policy applies only to the Web Sites and applications published by MoviesFree™ International.
      </p>
      <p className="font-bold mb-2">Note: Use of Information</p>
      <p className="text-gray-500 mb-6">
      Information that we collect  </p>
      <p className="text-gray-500 mb-6">
      MoviesFree™ may collect information from its users in three different ways: directly from the user, from traffic references of hostingservers and from cookies.
      </p>
     ...
     2. As otherwise described to you at the point of collection or with your consent.  
      ...
      We do not make warranties that this site will operate error free. If you see an error, please contact the <a className="font-bold text-blue-500 mb-6" href="mailto:drtrailer2022@gmail.com ">webmaster</a>. By entering this site you agree to hold the owners, employees, advertisers of MoviesFree™  free from any and all liability.This site (MoviesFree™ ) do not offer any membership.If you have any questions please feel free to <a className="font-bold text-blue-500 mb-6" href="mailto:drtrailer2022@gmail.com.com">contact us</a>.
      </p>
    </div>
