      ...
      <Link href={`/adult/${generateSlug(adultItem.title)}`}>
        <div style={styles.card} className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex flex-col sm:text-left text-center">
            <h2 style={styles.cardTitle} className="text-xl font-semibold mb-2">{adultItem.title}</h2>
            <p style={styles.cardDate} className="text-gray-500 text-sm mb-2">Upload Date: {adultItem.year}</p>
            <p style={styles.cardDescription} className="text-gray-600">{adultItem.synopsis}</p>
          </div>
        </div>
      </Link>
    </li>
