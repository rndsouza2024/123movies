...
import SearchComponent from "../../components/SearchComponent";
    ...
    export default function hindiDubbed({ hindiDubbedData }) {
      ...
      const NewsSchema = JSON.stringify({
        ...
        "name": "hindiDubbed Free™ – hindiDubbed Section.",
        ...
        "address": {
          "@type": "PostalAddress",
          "streetAddress": "hindiDubbed Free Broadcast India Limited,FC-23",
      ...
      const rankMathSchema = JSON.stringify({
        ...
        '@graph': [
          ...
          {
            '@type': 'WebSite',
            '@id': 'https://moviefree.vercel.app/hindiDubbed#website',
            url: 'https://moviefree.vercel.app/hindiDubbed',
            name: 'hindiDubbed Free™ – hindiDubbed Section.',
            publisher: {
              '@type': 'Organization',
              '@id': 'https://moviefree.vercel.app/#organization'
          ...
          {
            '@type': 'WebPage',
            '@id': 'https://moviefree.vercel.app/hindiDubbed#webpage',
            url: 'https://moviefree.vercel.app/hindiDubbed',
            name: 'hindiDubbed Free',
            ...
            mainEntity: [
              {
                '@type': 'Article',
                '@id': 'https://moviefree.vercel.app/hindiDubbed',
                url: 'https://moviefree.vercel.app/hindiDubbed',
                headline: 'hindiDubbed Free™',
                datePublished: '2024-01-13T13:00:00+00:00',
                dateModified: '2024-01-13T13:13:00+00:00',
                 publisher: {
                  '@type': 'Organization',
        ...
        "@graph": [
          {
            ...
            "@id": "https://moviefree.vercel.app/hindiDubbed",
            "url": "https://moviefree.vercel.app/hindiDubbed",
            "name": "hindiDubbed Free™ – Online. Stream. Download.",
            ...
            "breadcrumb": {
              "@id": "https://moviefree.vercel.app/hindiDubbed#breadcrumb",
            },
            "inLanguage": "en-US",
            "potentialAction": [
              {
                "@type": "ReadAction",
                "target": ["https://moviefree.vercel.app/hindiDubbed"],
              },
            ],
          },
          {
            ...
            "width": 1280,
            "height": 720,
            "caption": "hindiDubbed Free™ – Online. Stream. Download.",
          },
          {
            "@type": "BreadcrumbList",
            "@id": "https://moviefree.vercel.app/hindiDubbed#breadcrumb",
            "itemListElement": [
              {
                ...
                "item": "https://moviefree.vercel.app/hindiDubbed",
              },
            ],
          },
          {
          ...
          },
          {
            ...
            "logo": {
              "@type": "ImageObject",
              "inLanguage": "en-US",
              "@id": "https://moviefree.vercel.app/#logo",
              "url": "https://moviefree.vercel.app/logo.png",
      ...
      return (
        <>
        <Head>
        <title> hindiDubbed Free™ – Hindi Dubbed Section.</title>
        ...
        />
       <meta name="keywords" content="moviefree, hindiDubbed, watch movie online, free hindiDubbed, free hindiDubbed online, free movie streaming, moviefree hindiDubbed free streaming, download free" />
        <meta
          property="og:description"
          content="Stream HD hindiDubbed and TV series for free on hindiDubbedFree™. Explore, stream, and download full-length hindiDubbed and shows in HD quality without registration."
        />
        <meta
          name="description"
          content="Stream HD hindiDubbed and TV series for free on hindiDubbedFree™. Explore, stream, and download full-length hindiDubbed and shows in HD quality without registration."
        />
        <link rel="canonical" href="https://moviefree.vercel.app//hindiDubbed" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content=" hindiDubbed Free™ – hindiDubbed Section. "
        />
        <meta property="og:url" content="https://moviefree.vercel.app//hindiDubbed" />
        <meta
      ...
      <SocialSharing />
        ...
        <button onClick={goBackToMain} style={styles.pageButton}>
          ...
          <h1 style={styles.title}>Movies Free™ Hindi Dubbed Section.</h1>
...
<div className="flex flex-col items-center space-y-4 mt-4">
  ...
  {currenthindiDubbedItems.map((hindiDubbedItem, index) => (
    <li key={index} style={styles.hindiDubbedItem}>
      <Link href={`/hindiDubbed/${generateSlug(hindiDubbedItem.title)}`}>
        <div style={styles.card} className="flex flex-col sm:flex-row gap-4">
          <img
          ...
          <div className="flex flex-col sm:text-left text-center">
            <h2 style={styles.cardTitle} className="text-xl font-semibold mb-2">{hindiDubbedItem.title}</h2>
            <p style={styles.cardDate} className="text-gray-500 text-sm mb-2">Upload Date: {hindiDubbedItem.year}</p>
            <p style={styles.cardDescription} className="text-gray-600">{hindiDubbedItem.synopsis}</p>
          </div>
        </div>
      </Link>
    </li>
...
<div className="flex flex-col items-center space-y-4 mt-4">
  ...
  <div style={styles.totalPages}>
    ...
    const styles = {
      ...
      pageButton: { backgroundColor: "#007bff", color: "#fff", border: "none", padding: "10px 20px", borderRadius: "5px", cursor: "pointer",  textShadow: "1px 1px 0px #000",  fontSize: "20px",  margin: '0 5px', fontWeight:"bold" },
    };
