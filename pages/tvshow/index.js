...
export default function TvShowList({ tvshowData }) {
  ...
  const goBackToMain = () => {
    router.push("/");
        ...
        "@graph": [
          {
            ...
            "name": "Movies Free™ – Tv Show Section.",
          ...
          {
            "@type": "WebSite",
            "@id": "https://moviefree.vercel.app/tvshow#website",
          ...
          {
            "@type": "WebPage",
            "@id": "https://moviefree.vercel.app/tvshow#webpage",
            "url": "https://moviefree.vercel.app/tvshow",
            "name": "Movies Free",
      ...
      return (
        <>
        <Head>
        <title> Movies Free™ – Tv Show Section.</title>
       ...
       <meta name="keywords" content="moviefree, movies, watch movie online, free movies, free movies online, free movie streaming, moviefree movies free streaming, download free" />
        ...
        <meta
          ...
          content="Stream HD movies and TV series for free on MoviesFree™. Explore, stream, and download full-length movies and shows in HD quality without registration."
        />
        <link rel="canonical" href="https://moviefree.vercel.app//tvshow" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content=" Movies Free™ – Tv Show Section. "
        />
        <meta property="og:url" content="https://moviefree.vercel.app//tvshow" />
        <meta
      ...
      <Link href={`/tvshow/${generateSlug(tvshowitem.title)}`}>
        <div style={styles.card} className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex flex-col sm:text-left text-center">
            <h2 style={styles.cardTitle} className="text-xl font-semibold mb-2">{tvshowitem.title}</h2>
            <p style={styles.cardDate} className="text-gray-500 text-sm mb-2">Upload Date: {tvshowitem.year}</p>
            <p style={styles.cardDescription} className="text-gray-600">{tvshowitem.synopsis}</p>
          </div>
        </div>
      </Link>
    </li>
